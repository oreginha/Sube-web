...
const CuentaDNIQR: React.FC<CuentaDNIQRProps> = ({
    amount,
    accountInfo,
    onPaymentSuccess,
    onPaymentError
...
6304
    ...
    // Add timer functionality similar to MercadoPagoQR
    useEffect(() => {
    ...
    return (
        <QRContainer>
            <QRTitle>Pagar con CuentaDNI</QRTitle>
            ...
            <QRWrapper>
                <QRCode
                    ...
                    level="H"
                    marginSize={2}
                // QRCodeSVG component already renders as SVG by default
                />
            </QRWrapper>
            ...
            <QRInstructions>
                <p>1. Abrí la app de CuentaDNI</p>
